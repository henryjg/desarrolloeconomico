<template>
  ...
  <div class="row pt-3">
    <div class="col-12">
      <h4 class="text-secondary"><iconDocument class="wid-25 "/> Proyectar Documento a Jefatura</h4>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card pb-2 mb-2  rounded-1 shadow-sm">
          <div class="card-header py-1 bg-verdeolivo-5 rounded-top-1 text-white">
          ...
          <div class="card-body row py-2 ">
                ...
                <div class="col-md-6 mb-0">
                  ...
                  <!-- <div class="px-0 py-2 rounded-1 mt-1">
                    <div v-for="Item in Array_oficina_copia" :key="Item.id" class="d-flex border-bottom" style="margin-top: 1px; margin-bottom: 1px;">
                        <div class="w-100">{{ Item.destino }}</div>
                        <div class="flex-shrink-1">
                            <div class="btn f-4 btn-link-hover-danger btn-sm py-0" @click="Remove_Copia(Item.id)" >
                  ...
                  <div class="px-0 py-2 rounded-1 mt-1">
                    ...
                    <div v-if="Array_oficina_copia.length>0" class="align-content-center f-14 f-w-500 alert alert-secondary b-gray mb-0 py-1 px-2">
                      <span 
  ...
  <div class="row g-2 pt-1">
        ...
        <div class="card  rounded-1 shadow-sm mb-1">
          ...
          <div class="card-body p-3">           
            ...
            <div class="row g-1">
              ...
              <div class="col-md-3" v-if="DocumentoNuevo.prioridad==='Urgente'">
    ...
    <div class="col-md-5">
      ...
      <!-- CARD ADJUNTO ------------------- -->
      <div class="card  rounded-1 shadow-sm">
          <div class="card-header py-1 bg-verdeolivo-5 rounded-top-1 text-white d-flex">
              ...
              <div class="px-0 py-2  rounded-1 mt-1">
                ...
                <div v-else v-for="Item in Array_archivos" :key="Item.id" class="d-flex alert py-0 mb-1 alert-light" >
                    ...
                    <div  class="flex-shrink-1 align-content-center">
                      ...
                      <div v-else class="alert alert-warning py-0 mx-1 d-flex wid-150 m-auto  justify-content-center">
                        <iconFirma class="wid-30 py-0 my-0 p-r-10"/> {{ Item.estado_firma }}
                      </div>
                    </div>
  ...
  <div class="d-flex gap-2 g-1 justify-content-center">
        ...
        <div class="text-center" >
          <button :disabled="isSending"  @click="RegistrarProyectado" class="btn btn-lg w-100  btn-warning bg-yellow-800 border-0 mt-0 m-auto text-nowrap">
              <i class="fas fa-chevron-right p-r-5"></i>Proyectar Documento</button>
        </div>
                ...
                <div v-if="Array_referencias_elegidas.length>0">
                  ...
                  <div class="align-content-center f-14 f-w-500 alert alert-secondary b-gray mb-0 py-1 px-2">
                    <span
                       ...
                       <div v-else>N° {{ DocumentoNuevo.numeracion_tipodoc_oficina }} - {{ anioactual }} - {{ UsuarioActual.buzon_sigla }} - MDVO/D</div>
                    </span>
                  </div>
                </div>
                <!-- ----------------------- -->
...
import { add_documentoInterno, get_resultadoreferencias, subir_adjunto, get_correlativo_nrodocumento_buzon, get_documentoCompleto_primerpase } from '../../../services/DocumentoServices';
...
export default {
    ...
    setup () {
        ...
        const Remove_Copia = (id: string) => {
          ...
          if (index !== -1) {
            Array_oficina_copia.value.splice(index, 1);
          } else {
            Notif.Error("Elemento no encontrado");
          }
        };
         ...
         if (Array_oficina_original.value.length===0) {
          ...
          try {
              ...
              DocumentoNuevo.value.cabecera   =   StoreList.obtenerNombrePorId(DocumentoNuevo.value.tipodocumento_id.toString()) + " - N° " +
                                                  DocumentoNuevo.value.numeracion_tipodoc_oficina  + " - " + anioactual.value  + " - " + UsuarioActual.value.buzon_sigla  + " -MDVO/D";
              ...
              const RespuestaJSON = await add_documentoInterno(DocumentoNuevo.value, Array_oficina_original.value, Array_oficina_copia.value, idpase);
              //--------
              if (RespuestaJSON.success) {
                  //persona.value.id = RespuestaJSON.data;
                  Alerta.Sucessfull_timer("Completado","Documento agregado correctamente");
                  if(UsuarioActual.value.rol_id===1){
      ...
      return {
        ...
        UsuarioActual, BuscarReferencias,
        Array_referencias_elegidas,
        Add_Referencia,
