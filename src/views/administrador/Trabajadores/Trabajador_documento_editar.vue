            ...
            <div class="card  rounded-1 shadow-sm mb-1">
              ...
              <div class="card-body p-3">
                ...
                <div class="row g-1">
                  ...
                  <!-- -------------- -->
                  <div class="col-md-4">
                    <label class="form-label f-13">Tipo Documento</label>
                    <div class="d-flex ">
                            <input  v-model="DocumentoNuevo.proyectar"
                                    class="btn-check" checked type="radio" name="radioproyectado" value="false" id="lbl_radioproyectado1">
                            <label class=" btn btn-outline-secondary b-gray py-1 px-2 m-r-5 w-100 f-w-600" for="lbl_radioproyectado1"> Normal </label>
      
                            <input  v-model="DocumentoNuevo.proyectar"
                                    class="btn-check"  type="radio" name="radioproyectado" value="true" id="lbl_radioproyectado2">
                            <label class=" btn btn-outline-primary b-gray px-2 py-1 m-r-5 w-100 f-w-600" for="lbl_radioproyectado2"> Proyectado </label>
                    </div>
                    <ErrorMessage :error="errorsDoc.prioridad" />
                  </div>
                                    <!-- -------------- -->
              ...
              <div class="card-body px-3 py-2">
                  ...
                  <div class="px-0 py-2  rounded-1 mt-1">
                    ...
                    <div v-else v-for="Item in Array_archivos" :key="Item.id" class="d-flex alert py-0 mb-1 alert-secondary" >
                        ...
                        <!-- <div v-if="Usuario.jerarquia==='Jefe'" class="flex-shrink-1">
      ...
      <div class="d-flex gap-2 g-1 justify-content-center">
            ...
            <div  class="text-center" >
              <button @click="ActualizarDocumento" class="btn btn-lg w-100  btn-success mt-0 m-auto text-nowrap">
                  <i class="ph-duotone ph-floppy-disk p-r-5"></i>Actualizar y Enviar</button>
            </div>
            <!-- -------------------------------------------- -->
      </div>
    </div>
...
import { get_resultadoreferencias, subir_adjunto, get_correlativo_nrodocumento_buzon, get_documentoCompleto_primerpase, get_documentoCompleto_interno, getdestino_oficinas, upd_documento_interno, upd_documento_interno_TrabajadorCAS } from '../../../services/DocumentoServices';
        ...
        const ActualizarDocumento = async () => { 
         ...
         if (Array_oficina_original.value.length===0) {
          ...
          try {
              ...
              const RespuestaJSON = await upd_documento_interno_TrabajadorCAS(DocumentoNuevo.value, Array_oficina_original.value, Campo_proveido.value);
              //--------
              if (RespuestaJSON.success) {
