...
import { Aceptar_documento_proyectado, ConfirmarEnvio_documento_proyectado, get_listadocumentos_Proyectados, get_listadocumentos_Proyectados_NombreUsuario, Observar_documento } from '../../../services/DocumentoServices';
  ...
  setup() {
    ...
    const CargarExpedientes = async () => {
        try {
          ...
          NProgress.start();
          const RespuestaJSON = await get_listadocumentos_Proyectados_NombreUsuario(Usuario.value.username);
    ...
    const headers = ref([
      ...
      { text: 'Usuario.', width: '10%', key: 'usuarionombre', type: 'string' as const, sortable: false, filterable: false },
      { text: 'ASUNTO', width: '30%', key: 'asunto', type: 'string' as const, sortable: false, filterable: false },
      
      { text: 'DESTINO', width: '15%', key: 'pase_nombre_destino', type: 'string' as const, sortable: true, filterable: true },
      { text: 'CREADO EL', width: '5%', key: 'pase_fechaenvio', type: 'date' as const, sortable: true, filterable: false },
      { text: 'PDF', width: '2%', key: 'DOC', type: 'string' as const, sortable: false, filterable: false },
