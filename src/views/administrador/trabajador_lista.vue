          ...
          <div class="row">
            ...
            <div class="table-responsive d-none d-md-block">
              <div v-if="ListaTrabajadores.length===0" class="alert alert-warning mx-3">
                <i class="fa fa-user-friends"></i>
                No existen trabajadores registrados</div>
              <table v-else class="table table-hover table-xs" id="pc-dt-simple">
                <thead>
                  <tr>
...
import { deleteTrabajador, getTrabajadores, getUsuariosTramite } from '../../services/trabajadorService';
...
export default {
  ...
  setup() {
    ...
    const cargarUsuariosTramite = async () => {
      NProgress.start();
      try {
