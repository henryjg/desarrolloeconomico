<template>
  <CardLayout :title="'Correlación'" :clase="'text-blue-900'"  :clasehead="'bg-purple-600'">
          ...
          >
            <template #default="{ item, index, currentPage, itemsPerPage }">
              <tr>
                ...
                <!-- <td class="text-wrap"><div class="badge text-bg-danger">{{ item.documento_codexpediente }}</div></td> -->
