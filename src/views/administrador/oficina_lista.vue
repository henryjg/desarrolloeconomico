                  ...
                  <div class="table-responsive b-gray">
                      ...
                      <table class="table table-hover table-xs" id="pc-dt-simple">
                        <thead>
                          <tr>
                            <th style="width: 5%">#</th>
                            <th style="width: 90%">Nombre de la Oficina</th>
                            <th style="width: 5%"></th>
                          </tr>
                        </thead>
                        <tbody>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body py-1">
          ...
          <div class="mb-3">
            ...
            <select id="oficinaPadre" class="form-select" v-model="oficina.padre_id">
              <option :value="null">Ruta Raíz..</option>
              <option v-for="of in listaOficinas" :key="of.id" :value="of.id">{{ of.nombre }}</option>
            </select>
          </div>
        </div>
  ...
  setup() {
    ...
    const registrarOficina = async () => {
      ...
      try {
        ...
        if(oficina.value.padre_id!=="" && oficina.value.padre_id!==null){
          formData.append('padre_id', oficina.value.padre_id);
        }
