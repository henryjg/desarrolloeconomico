        ...
        <template #default>
          <DataTable
                ...
                :filterKeys="['asunto', 'procedencia',  'numerodocumento', 'cabecera', 'codigo', 
                              ...
                              'pase_buzondestino_nombre', 'fecharegistro','usuario_nombre']"
...
export default defineComponent({
  ...
  setup() {
    ...
    const headers = ref([
      { text: '#', width: '5px', key: 'index', type: 'string' as const, sortable: false, filterable: false }, 
      ...
      { text: 'PDF', width: '3%', key: 'acciones', type: 'string' as const, sortable: false, filterable: false },
