    ...
    <div class="col-md-4 justify-content-center align-content-center">
      <div class="p-5">
        <div class="text-center">
          <img src="../../assets/unidos.png" class="wid-150 p-3 m-0">
            <h3 class="f-w-500 mb-1 text-blue-600 pt-3   f-w-700">SISTEMA DE LICENCIAS MUNICIPALES</h3>
            <p class="text-blue-600 pt-4 mb-0 f-w-500">PANEL ADMINISTRATIVO.</p>
        ...
        <div class="d-grid mt-2">
            <button type="button" @click="IniciarSession" class="btn btn-success">
...
export default {
  ...
  return { IniciarSession, usuario, contrasena };
},
};
</script>
