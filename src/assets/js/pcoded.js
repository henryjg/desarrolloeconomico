...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '/src/assets/images/logo.png');
}
...
function layout_sidebar_change(value) {
  if (value == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/src/assets/images/logo.png');
    }
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/src/assets/images/logo_gmv.png');
    }
    var control = document.querySelector('.theme-sidebar-color .btn.active');
    if (control) {
      document.querySelector('.theme-sidebar-color .btn.active').classList.remove('active');
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '/src/assets/images/logo_gmv.png');
    }
    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', '/src/assets/images/logo_gmv.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/src/assets/images/logo_gmv.png');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '/src/assets/images/logo_gmv.png');
    }
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '/src/assets/images/logo.png');
    }
    
    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', '/src/assets/images/logo.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/src/assets/images/logo.png');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '/src/assets/images/logo.png');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
