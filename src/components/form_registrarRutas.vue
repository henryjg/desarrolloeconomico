<template>
  ...
  import { get_fotosRuta, del_fotoRuta, add_FotoActualRuta } from '../services/fotosService';
    ...
    setup() {
        ...
        const Listar_Fotos = async () => {
              try {
                  ...
                  //-------------------------------------------------------        
                  const RespuestaJSON = await get_fotosRuta();
        ...
        const delete_Foto = async (id: number) => {
          ...
          if (isConfirmado) {
              const RespuestaJSON = await del_fotoRuta(id);
              if(RespuestaJSON.success){
        ...
        const registrarFoto = async () => {
              ...
              try {
                NProgress.start();
                //--------
                const RespuestaJSON = await add_FotoActualRuta(formData);
                if(RespuestaJSON.success){
                    Listar_Fotos();
                    Notif.Success(RespuestaJSON.message);
                    resetFileInput();
